    ...
    <>
      <div>
        ...
        <div className="flex flex-col gap-3 lg:hidden">
          ...
          <div className="flex items-center gap-3 px-4 md:px-4 md:w-screen text-xl">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(90deg, rgb(34, 34, 34) 24.97%, rgb(34, 34, 34) 34.3%, rgba(34, 34, 34, 0.04) 97.4%, rgb(34, 34, 34) 100%)",
            }}
          ></div>
